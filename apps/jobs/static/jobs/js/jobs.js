const SHOW_JOB_BTN_TEXT = '<i class="fas fa-chevron-circle-down"></i> Mostrar descripción';
const HIDE_JOB_BTN_TEXT = '<i class="fas fa-chevron-circle-up"></i> Ocultar descripción';
