    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_at', models.DateTimeField(default=apps.events.time_utils.now)),
                ('finish_at', models.DateTimeField(default=functools.partial(apps.events.time_utils.now_plus, *(), **{'hours': 3}))),
