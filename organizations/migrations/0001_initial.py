    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('management_email', models.EmailField(blank=True, help_text='Management email of the organization used during the event', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Organization',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=32, unique=True)),
                ('description', models.TextField(blank=True)),
                ('logo', models.FileField(blank=True, upload_to='organizations/group/')),
            ],
        ),
        migrations.AddField(
            model_name='organizationcategory',
            name='role',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='organization_categories', to='organizations.OrganizationRole'),
        ),
        migrations.AddField(
